...
urlpatterns = [
    ...
    path('certificate/<str:cert_code>/', course.CertificateDetailView.as_view(), name='certificate_detail'),
    path('certificate/<str:cert_code>/pdf/', course.CertificatePdfView.as_view(), name='certificate_pdf'),
