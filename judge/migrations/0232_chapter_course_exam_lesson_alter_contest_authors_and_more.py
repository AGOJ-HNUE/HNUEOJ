# Generated by Django 4.2.30 on 2026-08-09 12:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, verbose_name='Mô tả chương')),
                ('order_index', models.PositiveIntegerField(db_index=True, default=0, verbose_name='Thứ tự')),
            ],
            options={
                'verbose_name': 'Chương học',
                'verbose_name_plural': 'Các chương học',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('key', models.SlugField(max_length=64, unique=True, validators=[django.core.validators.RegexValidator('^[a-z0-9-]+$', 'Chỉ chấp nhận chữ thường, số và dấu gạch ngang.')], verbose_name='Mã khóa học / Slug')),
                ('title', models.CharField(db_index=True, max_length=255, verbose_name='Tên khóa học')),
                ('description', models.TextField(blank=True, verbose_name='Mô tả khóa học')),
                ('status', models.CharField(choices=[('DRAFT', 'Bản nháp'), ('PUBLISHED', 'Đã xuất bản'), ('ARCHIVED', 'Lưu trữ')], db_index=True, default='DRAFT', max_length=16, verbose_name='Trạng thái')),
                ('is_public', models.BooleanField(default=True, help_text='Cho phép mọi học viên tìm kiếm và xem đề cương khóa học.', verbose_name='Hiển thị công khai')),
                ('thumbnail_url', models.CharField(blank=True, default='', max_length=255, verbose_name='Ảnh bìa khóa học')),
                ('order_index', models.PositiveIntegerField(default=0, verbose_name='Thứ tự sắp xếp')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, verbose_name='Mô tả / Quy chế thi')),
                ('target_type', models.CharField(choices=[('COURSE', 'Khóa học (Cuối khóa)'), ('CHAPTER', 'Chương (Kiểm tra phần)')], default='CHAPTER', max_length=16, verbose_name='Cấp độ gắn kết')),
                ('exam_type', models.CharField(choices=[('PRACTICE', 'Luyện tập (Không tính Rating)'), ('RATED', 'Tính Rating')], default='PRACTICE', max_length=16, verbose_name='Loại kỳ thi')),
                ...
                ('time_limit', models.DurationField(blank=True, null=True, verbose_name='Thời lượng làm bài')),
                ('order_index', models.PositiveIntegerField(db_index=True, default=0, verbose_name='Thứ tự')),
                ('pass_percentage', models.FloatField(default=60.0, verbose_name='Điểm đạt (%)')),
                ('is_published', models.BooleanField(default=True, verbose_name='Đã xuất bản')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Ngày tạo')),
                ('chapter', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='exams', to='judge.chapter', verbose_name='Chương')),
            ],
            options={
                'verbose_name': 'Kỳ thi khóa học',
                'verbose_name_plural': 'Các kỳ thi khóa học',
                'ordering': ('order_index', 'id'),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField(blank=True, verbose_name='Nội dung bài học (Markdown / HTML)')),
                ('video_url', models.URLField(blank=True, null=True, verbose_name='Link video bài giảng')),
                ('order_index', models.PositiveIntegerField(db_index=True, default=0, verbose_name='Thứ tự')),
                ('is_published', models.BooleanField(default=True, verbose_name='Đã xuất bản')),
                ('estimated_minutes', models.PositiveIntegerField(default=15, verbose_name='Thời lượng ước tính (phút)')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Ngày tạo')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Ngày cập nhật')),
                ('chapter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lessons', to='judge.chapter', verbose_name='Chương')),
            ],
            options={
                'verbose_name': 'Bài học lý thuyết',
                'verbose_name_plural': 'Các bài học lý thuyết',
                'ordering': ('order_index', 'id'),
            },
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('alias', models.CharField(blank=True, help_text='Ghi đè tên hiển thị của bài tập trong kỳ thi.', max_length=255, verbose_name='Tên bài hiển thị tùy biến')),
                ('custom_score', models.FloatField(blank=True, help_text='Ghi đè điểm tối đa của bài tập trong kỳ thi.', null=True, verbose_name='Điểm số tùy biến')),
                ('order_index', models.PositiveIntegerField(db_index=True, default=0, verbose_name='Thứ tự sắp xếp')),
                ('partial', models.BooleanField(default=True, verbose_name='Cho phép chấm điểm từng phần')),
                ('exam', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='exam_problems', to='judge.exam', verbose_name='Kỳ thi')),
                ('problem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='exam_problems', to='judge.problem', verbose_name='Bài tập gốc')),
            ],
            options={
                'verbose_name': 'Bài tập trong kỳ thi',
                'verbose_name_plural': 'Các bài tập trong kỳ thi',
                'ordering': ('order_index', 'id'),
        ...
        migrations.AddField(
            model_name='exam',
            name='contest',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='course_exams', to='judge.contest', verbose_name='Kỳ thi liên kết (Tùy chọn)'),
        ),
        migrations.AddField(
            model_name='exam',
            name='course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='exams', to='judge.course', verbose_name='Khóa học'),
        ),
        migrations.AddField(
            model_name='exam',
            name='problems',
            field=models.ManyToManyField(related_name='course_exams', through='judge.ExamProblem', to='judge.problem', verbose_name='Bài tập'),
        ),
        migrations.AddField(
            model_name='course',
            name='instructor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='instructed_courses', to='judge.profile', verbose_name='Giảng viên'),
        ),
        migrations.AddField(
            model_name='chapter',
            name='course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='chapters', to='judge.course', verbose_name='Khóa học'),
        ),
        migrations.AddField(
            model_name='submission',
            name='exam',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='submissions', to='judge.exam', verbose_name='exam'),
        ),
        migrations.CreateModel(
            name='LessonProgress',
            fields=[
                ...
                ('lesson', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='progresses', to='judge.lesson', verbose_name='Bài học')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lesson_progresses', to='judge.profile', verbose_name='Học viên')),
            ],
            options={
                'verbose_name': 'Tiến độ bài học',
                'verbose_name_plural': 'Tiến độ bài học',
                'indexes': [models.Index(fields=['user', 'lesson'], name='judge_lesso_user_id_226403_idx')],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('progress_percentage', models.FloatField(default=0.0, verbose_name='Tiến độ (%)')),
                ('status', models.CharField(choices=[('ACTIVE', 'Đang học'), ('READY_FOR_REVIEW', 'Chờ duyệt cấp chứng chỉ'), ('COMPLETED', 'Đã hoàn thành / Nhận chứng chỉ'), ('DROPPED', 'Đã hủy')], db_index=True, default='ACTIVE', max_length=20, verbose_name='Trạng thái')),
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='enrollments', to='judge.course', verbose_name='Khóa học')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='course_enrollments', to='judge.profile', verbose_name='Học viên')),
            ],
            options={
                'verbose_name': 'Ghi danh khóa học',
                'verbose_name_plural': 'Danh sách ghi danh',
                'indexes': [models.Index(fields=['course', 'status'], name='judge_enrol_course__7b1a24_idx'), models.Index(fields=['user', 'course'], name='judge_enrol_user_id_438f3d_idx')],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cert_code', models.CharField(db_index=True, max_length=64, unique=True, verbose_name='Mã chứng chỉ')),
                ('issued_date', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Ngày cấp')),
                ('grade', models.CharField(default='Xuất sắc', max_length=50, verbose_name='Xếp loại')),
                ('verification_url', models.URLField(blank=True, verbose_name='Đường dẫn xác thực')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='issued_certificates', to='judge.course', verbose_name='Khóa học')),
                ('issued_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='authorized_certificates', to='judge.profile', verbose_name='Giảng viên cấp')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='certificates', to='judge.profile', verbose_name='Học viên')),
            ],
            options={
