...
class ContestAdmin(AdminFastPaginationMixin, NoBatchDeleteMixin, SortableAdminBase, VersionAdmin):
    fieldsets = (
        ...
        (_('Scheduling'), {'fields': ('start_time', 'end_time', 'province', 'is_province_contest', 'registration_start', 'registration_end',
                                      'time_limit')}),
    ...
    list_display = ('key', 'name', 'province', 'is_province_contest', 'is_visible', 'is_rated', 'locked_after', 'start_time', 'end_time', 'time_limit',
                    'user_count')
    list_filter = ('is_province_contest', 'province', 'is_visible', 'is_rated')
