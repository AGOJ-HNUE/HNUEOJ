...
class SubmissionSource(SubmissionDetailBase):
    ...
    def get_context_data(self, **kwargs):
        ...
        try:
            ...
            source_text = ''
        context['raw_source'] = source_text.rstrip('\n')
        context['highlighted_source'] = highlight_code(source_text, submission.language.pygments) if source_text else ''
        return context
    ...
    def get(self, request, *args, **kwargs):
        try:
            ...
            try:
                ...
                source_text = ''
            return HttpResponse(source_text, content_type='text/plain')
